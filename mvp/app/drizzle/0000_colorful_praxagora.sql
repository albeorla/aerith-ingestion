...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "app_purpose" ADD CONSTRAINT "app_purpose_user_id_app_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."app_user"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "vision_unique_name_per_user_idx" ON "app_vision" USING btree ("user_id","name");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "task_unique_name_per_user_idx" ON "app_task" USING btree ("user_id","name");